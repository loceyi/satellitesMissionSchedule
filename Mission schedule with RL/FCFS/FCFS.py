...
from globalVariableLocal import get_value_taskList,\
    get_value_TaskTotal,initTasklist,initTask
# Task = {
...
#     '7': [68, 68, 1, 2, -0.000506125053969096],
...
#     '12': [210, 210, 1, 2, 0.000686616104577854],
#     '6': [222, 222, 1, 2, -0.00034561912981283],
#     '9': [266, 266, 1, 2, -0.000627053588052687],
#     '15': [281, 281, 1, 2, -0.000249234646338898],
#     '4': [313, 313, 1, 2, 0.000346407017990367],
#     '10': [424, 424, 1, 2, 0.00014618739102126],
#     '17': [441, 441, 1, 2, -0.000132150261068142],
#     '5': [493, 493, 1, 2, -0.000143827287224467],
#     '11': [493, 493, 1, 2, -0.00006707423124954]
#
# }
initTasklist()
initTask()
Task=get_value_TaskTotal()
